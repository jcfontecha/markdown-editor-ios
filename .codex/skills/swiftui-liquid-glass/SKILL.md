...
- Assume iOS 26+ deployment and avoid availability branching.
...
- Assume iOS 26+ and use Liquid Glass directly without fallback branches.

## Review Checklist
- **Availability**: No `#available(iOS 26, *)` checks or fallback UI.
...
- Keep the implementation on the single iOS 26+ code path.
