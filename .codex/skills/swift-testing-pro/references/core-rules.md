...
- Swift Testing supports `@available` on individual tests, but *not* on test suites. In this repo, avoid iOS availability annotations entirely because the app assumes iOS 26+ everywhere.
