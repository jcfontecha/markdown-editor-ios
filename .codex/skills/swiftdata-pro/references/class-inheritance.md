...
This works the same as regular class inheritance in Swift. In generic projects you may see explicit availability annotations discussed for coordinated release platforms, but in this repo you should not add iOS availability annotations because the deployment target is already iOS 26+.
...
**Repo note:** Do not add `@available(iOS 26, *)` to these models in this codebase.
